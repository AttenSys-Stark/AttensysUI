...
const Insight = () => {
  ...
  return (
    <div className='h-auto pb-8 md:pb-32'>
        <div className='w-[92%] sm:w-[90%] md:w-[992px] h-[100%] mx-auto'>
            <div className='w-[196px] h-[184px] rounded-lg overflow-hidden relative mx-auto md:mx-0'>
                <Image src={story} alt="story" objectFit="cover" layout='fill' />
            </div>

            <h1 className='mt-3 text-[29.7px] text-[#ABADBA] font-bold leading-[68px] text-center md:text-left'>Event Name</h1>

            <div>
                <div className='flex flex-col md:flex-row justify-between items-center gap-3 md:gap-0'>
                    <h1 className='font-medium text-[16px] text-[#2D3A4B] leading-[18.15px]'>Event Registration</h1>
                    <Button className='w-full md:w-[155px] bg-[#2D3A4B91] text-[#FFFFFF] font-light text-[14px] rounded-lg h-[39px] items-center flex justify-center'>
                ...
                <div className='flex flex-col md:flex-row md:justify-between mt-3'>
                    ...
                    <div className='w-full md:w-[396px] bg-[#2D3A4B] rounded-lg shadow-sm mt-4 md:mt-0'>                 
                        <div className='flex flex-col md:flex-row justify-between px-4 md:px-14 pt-6 md:pt-10 pb-6'>
                        ...
                        <div className='flex flex-col md:flex-row justify-between px-4 md:px-14 pb-6'>
                            <div className='space-y-3'>
                        ...
                        <div className='flex flex-col md:flex-row justify-between px-4 md:px-14 pb-4'>
                            <div className='space-y-3'>
                ...
                <div className='w-full md:w-[992px] bg-[#FFFFFF] h-auto md:h-[362px] rounded-lg mt-4 shadow-sm'>
                    <div className='w-[90%] md:w-[80%] mx-auto pt-6 md:pt-12'>
                        <h1>Event Registration URL</h1>
                        <div className='w-full md:w-[626px] h-[60px] border-[2px] rounded-2xl mt-5 flex items-center justify-between px-3 md:px-5'>
                            <h1 className='border-r-[2px] h-[60px] flex items-center pr-4 text-sm md:text-base'>https://attensys.io</h1>
                    ...
                    <div className='w-[90%] md:w-[80%] mx-auto pt-6 md:pt-12'>
                        ...
                        <div className='flex flex-col md:flex-row gap-3 items-start md:items-center'>
                            ...
                            <Button className='w-full md:w-[155px] bg-[#4A90E21F] text-[#5801A9] font-normal text-[14px] rounded-lg h-[48px] items-center flex justify-center mt-5'>
                ...
                <div className='flex justify-end'>
                    <Button className='w-full md:w-[155px] bg-[#E0515152] text-[#730404] font-normal text-[14px] rounded-lg h-[48px] items-center flex justify-center mt-5'>
