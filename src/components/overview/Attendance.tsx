...
const Attendance = () => {
  ...
  const handleScan = (detectedCodes: IDetectedBarcode[]): void => {
      ...
      <div className="h-[930px] w-[80%] mx-auto bg-[#FFFFFF] mt-4 rounded-lg">
        <div className="flex justify-between px-16 pt-10">
          ...
          <div className="flex space-x-8">
            ...
            <Button
              onClick={() => setShowScanner(true)}
              className=" hidden lg:flex rounded-lg justify-center bg-[#2D3A4B] py-2 px-4 lg:h-[42px] items-center lg:w-[140px] text-sm text-[#FFFFFF] data-[hover]:bg-sky-500 data-[active]:bg-sky-700"
            >
