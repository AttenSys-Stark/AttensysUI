...
#[derive(Debug)]
pub struct coursecontract<A: starknet::accounts::ConnectedAccount + Sync> {
    pub address: starknet::core::types::Felt,
    pub account: A,
    pub block_id: starknet::core::types::BlockId,
}
impl<A: starknet::accounts::ConnectedAccount + Sync> coursecontract<A> {
...
#[derive(Debug)]
pub struct coursecontractReader<P: starknet::providers::Provider + Sync> {
    pub address: starknet::core::types::Felt,
    pub provider: P,
    pub block_id: starknet::core::types::BlockId,
}
impl<P: starknet::providers::Provider + Sync> coursecontractReader<P> {
...
impl cainome::cairo_serde::CairoSerde for Course {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size += Uri::cairo_serialized_size(&__rust.uri);
        __size
    ...
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        ...
        __out.extend(Uri::cairo_serialize(&__rust.uri));
        __out
            .extend(
    ...
    fn cairo_deserialize(
        ...
        let uri = Uri::cairo_deserialize(__felts, __offset)?;
        __offset += Uri::cairo_serialized_size(&uri);
...
pub struct CourseReplaced {
    pub course_identifier: cainome::cairo_serde::U256,
    pub owner_: cainome::cairo_serde::ContractAddress,
    pub new_course_uri_a: starknet::core::types::Felt,
    pub new_course_uri_b: starknet::core::types::Felt,
}
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        ...
        __size
            += starknet::core::types::Felt::cairo_serialized_size(
                &__rust.new_course_uri_a,
            );
        __size
            += starknet::core::types::Felt::cairo_serialized_size(
                &__rust.new_course_uri_b,
            );
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        ...
        __out
            .extend(
                starknet::core::types::Felt::cairo_serialize(&__rust.new_course_uri_a),
            );
        __out
            .extend(
                starknet::core::types::Felt::cairo_serialize(&__rust.new_course_uri_b),
            );
        __out
    }
    fn cairo_deserialize(
        ...
        __offset
            += cainome::cairo_serde::ContractAddress::cairo_serialized_size(&owner_);
        let new_course_uri_a = starknet::core::types::Felt::cairo_deserialize(
            __felts,
            __offset,
        )?;
        __offset
            += starknet::core::types::Felt::cairo_serialized_size(&new_course_uri_a);
        let new_course_uri_b = starknet::core::types::Felt::cairo_deserialize(
            __felts,
            __offset,
        )?;
        __offset
            += starknet::core::types::Felt::cairo_serialized_size(&new_course_uri_b);
        Ok(CourseReplaced {
            course_identifier,
            owner_,
            new_course_uri_a,
...
#[derive(serde::Serialize, serde::Deserialize)]
pub struct Uri {
    pub first: starknet::core::types::Felt,
    pub second: starknet::core::types::Felt,
}
impl cainome::cairo_serde::CairoSerde for Uri {
    ...
    fn cairo_serialized_size(__rust: &Self::RustType) -> usize {
        let mut __size = 0;
        __size += starknet::core::types::Felt::cairo_serialized_size(&__rust.first);
        __size += starknet::core::types::Felt::cairo_serialized_size(&__rust.second);
        __size
    }
    fn cairo_serialize(__rust: &Self::RustType) -> Vec<starknet::core::types::Felt> {
        let mut __out: Vec<starknet::core::types::Felt> = vec![];
        __out.extend(starknet::core::types::Felt::cairo_serialize(&__rust.first));
        __out.extend(starknet::core::types::Felt::cairo_serialize(&__rust.second));
        __out
    }
    fn cairo_deserialize(
        __felts: &[starknet::core::types::Felt],
        ...
        let mut __offset = __offset;
        let first = starknet::core::types::Felt::cairo_deserialize(__felts, __offset)?;
        __offset += starknet::core::types::Felt::cairo_serialized_size(&first);
        let second = starknet::core::types::Felt::cairo_deserialize(__felts, __offset)?;
        __offset += starknet::core::types::Felt::cairo_serialized_size(&second);
        Ok(Uri { first, second })
    }
}
#[derive(serde::Serialize, serde::Deserialize)]
...
impl TryFrom<starknet::core::types::EmittedEvent> for Event {
    ...
    fn try_from(
                ...
                .unwrap_or_else(|_| panic!("Invalid selector for {}", "CourseReplaced"))
        {
            ...
            data_offset
                += cainome::cairo_serde::ContractAddress::cairo_serialized_size(&owner_);
            let new_course_uri_a = match starknet::core::types::Felt::cairo_deserialize(
                &event.data,
                data_offset,
            ) {
                Ok(v) => v,
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}",
                            "new_course_uri_a", "CourseReplaced", e
                        ),
                    );
                }
            };
            data_offset
                += starknet::core::types::Felt::cairo_serialized_size(&new_course_uri_a);
            let new_course_uri_b = match starknet::core::types::Felt::cairo_deserialize(
                &event.data,
                data_offset,
            ) {
                Ok(v) => v,
                Err(e) => {
                    return Err(
                        format!(
                            "Could not deserialize field {} for {}: {:?}",
                            "new_course_uri_b", "CourseReplaced", e
                        ),
                    );
                }
            };
...
impl<A: starknet::accounts::ConnectedAccount + Sync> coursecontract<A> {
    ...
    pub fn add_replace_course_content_getcall(
        ...
        course_identifier: &cainome::cairo_serde::U256,
        owner_: &cainome::cairo_serde::ContractAddress,
        new_course_uri_a: &starknet::core::types::Felt,
        new_course_uri_b: &starknet::core::types::Felt,
        ...
        __calldata
            .extend(cainome::cairo_serde::ContractAddress::cairo_serialize(owner_));
        __calldata
            .extend(starknet::core::types::Felt::cairo_serialize(new_course_uri_a));
        __calldata
            .extend(starknet::core::types::Felt::cairo_serialize(new_course_uri_b));
        starknet::core::types::Call {
            to: self.address,
